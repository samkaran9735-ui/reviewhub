          ...
          <div className="products-grid">
            {filtered.map(product => (
              <div key={product.id} style={{ background: '#fff', border: '1px solid #eee', borderRadius: '12px', overflow: 'hidden' }}>
                <div style={{ background: '#f8f8f6', height: '100px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '44px', position: 'relative' }}>
                  {product.emoji}
                  <button
                ...
                <div style={{ padding: '10px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '6px' }}>
                    ...
                    <Link href={`/product/${product.id}`} style={{ flex: 1, padding: '6px', fontSize: '11px', border: 'none', borderRadius: '8px', background: '#378ADD', color: '#fff', textAlign: 'center', textDecoration: 'none' }}>
                      View
                    </Link>
                  </div>
                </div>
